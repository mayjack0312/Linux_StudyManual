...
![img](v2-012ee665b35eb28bca5c88269765f069_720w.webp)
...
![img](v2-496211e59b1d9ad60c00facd22b051bb_720w.webp)
...
![img](v2-1a827f87a39a2dc60210641d58550815_720w.webp)
...
![img](v2-5b6276c060823603a0ba47ebd86708fa_720w.webp)
...
![img](v2-ca58204812ee5d6f99b1ec329d4ba336_720w.webp)
...
![img](v2-8967e74f0a254a2b248797e0799a469f_720w.webp)

- 这之后，5,6,7 这个元素就可以被安全的释放了：

![img](v2-eaa5c8018d4881fd75b7679190804d05_720w.webp)
...
![img](v2-7c98797d5c46f6ec578f73367bf48539_720w.webp)
...
![img](v2-29c9713c93585e62275d53a59afb3c91_720w.webp)

- 第二行把旧的元素的内容拷贝给新的元素：

![img](v2-31e7ed70baf14bbf03e6da6d1b7fa789_720w.webp)

- 第三行，将 q->b 更新为2：

![img](v2-e2f9f26c5c686f526a308c29f379d9c6_720w.webp)

- 第四行，将 q->c 更新为3：

![img](v2-528c4fbc5af72c30b4c3ab45a1951021_720w.webp)

- 现在，第5行进行替换操作，这里，新元素最终对读者可见了。到了这里，如下所示，我们有了这个链表的两个版本。先前已经存在的读者可以看到 5,6,7 元素，而新读者将看到 5,2,3 元素。不过，任何读者都被保证可以看到一个完整的链表。

![img](v2-5306ffd65ecd6a45b4531f47758746f3_720w.webp)
...
![img](v2-b108855ba36180615dfbedab4e48ed1a_720w.webp)

- 第七行的 kfree() 完成后，链表旧成为了如下的样子：

![img](v2-98f007f889db00e72742635c8273c068_720w.webp)
