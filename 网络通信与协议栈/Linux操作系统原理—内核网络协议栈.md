...
![img.png](42e0689805e556fc.png)

分用：当目的主机收到一个以太网数据帧时，数据就开始从内核网络协议栈中由底向上升，同时去掉各层协议加上的报文首部。每层协议都会检查报文首部中的协议标识，以确定接收数据的上层协议。这个过程称作分用。

![img.png](d42c62b0d82c41e4.png)

## Linux 内核网络协议栈

### 协议栈的全景图

![img.png](f59c2e167eaedd09.png)

### 协议栈的分层结构

![img.png](0bf912c37bbfe692.png)

![img.png](f014ca04c2ce0d56.png)
...
![img.jpeg](dd6436eded9c9c95.jpg)

### 协议栈的数据结构

![img.png](d5447bc620ef3a94.png)
...
![img.png](d68ee937ad7c4289.png)

## 内核中断收包流程

![35.png](f242d794832ae1bb.png)

## UDP 收包流程

[![WTgrxf.png](WTgrxf.png)](https://imgtu.com/i/WTgrxf)

## UDP 发包流程

[![WTgDRP.png](WTgDRP.png)](https://imgtu.com/i/WTgDRP)
